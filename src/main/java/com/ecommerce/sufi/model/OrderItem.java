...
public class OrderItem {
 ...
 @Enumerated(EnumType.STRING) @Column(nullable = false, columnDefinition = "varchar(20) default 'PLACED'") private OrderItemStatus status = OrderItemStatus.PLACED;
 @Column(nullable = false, columnDefinition = "boolean default false") private boolean stockRestored;
}
